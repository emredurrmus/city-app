...
public class PopulerCard extends VerticalLayout {
    ...
    public static PopulerCard create(Post post, SerializableConsumer<Post> detailAction) {
        return new PopulerCard(post, detailAction);
    }

    public PopulerCard(Post post, SerializableConsumer<Post> detailAction) {
        setSpacing(false);
