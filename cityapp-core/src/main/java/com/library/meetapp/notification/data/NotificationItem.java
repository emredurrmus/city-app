package com.library.meetapp.notification.data;
...
public class NotificationItem {
    ...
    public NotificationItem(String type, String title, String description) {
        this(type, UUID.randomUUID().toString(), title, description, LocalDateTime.now(), false);
    }

    public NotificationItem(String type, String key, String title, String description, LocalDateTime datetime, boolean read) {
